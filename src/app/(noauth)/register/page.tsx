  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-10 md:gap-20 w-full md:p-5 lg:p-10 box-border md:justify-center order-2 md:order-1">
        <span className="text-white text-4xl font-bold">Create an account</span>
        <div className="flex flex-col gap-12">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              <label className="label" htmlFor="repeatPassword">First Name</label>
              <input
                className="input"
                type="text"
                name="firstName"
            ...
            <div className="flex flex-col gap-2">
              <label className="label" htmlFor="repeatPassword">Last Name</label>
              <input
                className="input"
                type="text"
                name="lastName"
            ...
            <div className="flex flex-col gap-2">
              <label className="label" htmlFor="repeatPassword">Email</label>
              <input
                className="input"
                type="text"
                name="email"
          ...
          <div className="flex flex-col gap-4">
            ...
            >Register</button>
            <span className="text-text">Already have an account? <Link className="link" href="/login">Sign Up</Link></span>
          </div>
