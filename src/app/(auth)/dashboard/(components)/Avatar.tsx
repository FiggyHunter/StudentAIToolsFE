  ...
  return (
    <div>
      <div id="avatar" className="flex items-center gap-3 relative">
        ...
        ></img>
        <div
          className={`w-[200px] bg-primaryColor absolute right-0 top-[68px] p-2 rounded-2xl flex-col gap-1 ${
            isProfileOpen ? "flex" : "hidden"
          }`}
        >
          <Link
            href=""
            className="py-2 px-3 flex gap-3 items-center no-underline hover:bg-[#464A57] rounded-lg transition"
          >
            <svg
              width="17"
              height="18"
          ...
          <Link
            ...
            href="/login"
            className="py-2 px-3 flex gap-3 items-center no-underline hover:bg-[#C92C2C] rounded-lg transition"
          >
            <svg
              width="18"
              height="18"
            ...
            >
              ...
              />
              <path
                d="M14.5386 6.53845L17.0001 8.99999L14.5386 11.4615"
                stroke="white"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
