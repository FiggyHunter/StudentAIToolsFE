...
const Sidebar: React.FC<SidebarProps> = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  return (
    <div
      className={`flex flex-col gap-10 justify-between fixed top-0 w-[350px] box-border bg-primaryColor p-7 overflow-auto h-[100vh] transition-all duration-700 lg:left-0 ${
        isSidebarOpen ? "left-0" : "left-[-350px]"
      } z-40`}
    >
      <div className="flex flex-col gap-10">
        <div className="flex items-center w-full justify-between">
          <span className="uppercase text-white font-bold text-[36px]">
            Logo
          </span>
          <svg
        ...
        <div className="flex flex-col gap-10">
          <div className="flex flex-col gap-4">
            <span className="text-primaryTint3 uppercase text-[12px] tracking-normal font-bold">
              Features
            </span>
      ...
      <Link href="" className="button special no-underline mt-10">
        Upgrade your plan
      </Link>
    </div>
  );
