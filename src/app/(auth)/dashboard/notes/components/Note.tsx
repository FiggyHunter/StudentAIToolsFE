  ...
  return (
    <div className='aspect-square bg-[#F7F18E] p-4 flex flex-col gap-4 w-full rounded-2xl box-border'>
        <div className='flex gap-2 justify-between items-center'>
            <p className='font-bold text-xl text-[#82362D]'>Ado je baba</p>
        ...
        <p className='text-medium text-lg sm:text-base text-[#82362D] text-wrap w-full line-clamp-2'>Hahahaha q hahah q ha ha ha ha q hahahahahah q hah aha hahaha</p>
    </div>
  )
}
